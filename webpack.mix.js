...
mix.scripts([
	...
	'resources/assets/admin/js/jquery.nicescroll.js',
	'resources/assets/admin/js/jquery-ui-1.9.2.custom.min.js',
	'resources/assets/admin/js/ga.js',
	'resources/assets/admin/js/bootstrap-switch.js',
	'resources/assets/admin/js/jquery.tagsinput.js',
	'resources/assets/admin/js/jquery.hotkeys.js',
	'resources/assets/admin/js/bootstrap-wysiwyg.js',
	'resources/assets/admin/js/bootstrap-wysiwyg-custom.js',
	'resources/assets/admin/js/moment.js',
	'resources/assets/admin/js/bootstrap-colorpicker.js',
	/*'resources/assets/admin/js/daterangepicker.js',*/
	'resources/assets/admin/js/bootstrap-datepicker.js',
	/*'resources/assets/admin/plugins/ckeditor/ckeditor.js',
	'resources/assets/admin/plugins/ckfinder/ckfinder.js',*/
	'resources/assets/admin/ckeditor/ckeditor.js',
	'resources/assets/admin/js/form-component.js',
	'resources/assets/admin/js/scripts.js',
], 'public/js/admin-form-component.js');
