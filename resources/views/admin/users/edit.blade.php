...
<!--main content start-->
    <section id="main-content">
      <section class="wrapper">
        <div class="row">
          <div class="col-lg-12">
            <h3 class="page-header"><i class="fa fa-user-md"></i> Редактировать пользователя</h3>
            <ol class="breadcrumb">
              <li><i class="fa fa-home"></i><a href="{{route('admin')}}">Главная</a></li>
              <li><i class="icon_documents_alt"></i>Редактировать пользователя</li>
            </ol>
          </div>
        </div>
        <div class="row">
                        ...
                        {{-- <form class="form-horizontal" role="form"> --}}
                          ...
                          <div class="form-group">
                            <div class="col-lg-offset-2 col-lg-10">
                              ...
                              <a href="{{route('users.index')}}" type="reset" class="btn btn-danger">Назад</a>
                            </div>
                          </div>
                        {{Form::close()}}
                      </div>
