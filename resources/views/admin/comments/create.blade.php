...
<section id="main-content">
  <section class="wrapper">
    <div class="row">
      <div class="col-lg-12">
        <h3 class="page-header"><i class="fa fa-file-text-o"></i> Создать комментарий  </h3>
        <ol class="breadcrumb">
          <li><i class="fa fa-home"></i><a href="index.html">Главная</a></li>
          <li><i class="icon_document_alt"></i>Создать комментарий</li>
        </ol>
      </div>
    </div>
    <div class="row">
          ...
          <div class="panel-body">
            {{Form::open([
              ...
              <div class="form-group">
                ...
                <div class="col-sm-10">
                  <textarea type="text" name="descr" id="ckeditor-comment" class="form-control" placeholder="Текст комментария"></textarea>
                </div>
